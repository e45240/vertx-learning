...
public class HttpServerVerticle extends AbstractVerticle {
    ...
    public void start(Future<Void> startFuture) throws Exception {
        ...
        int portNumber = config().getInteger(CONFIG_HTTP_SERVER_PORT, 8088);
    ...
    private void pageDeletionHandler(RoutingContext context) {
        ...
        vertx.eventBus()
                .rxSend(wikiDbQueue, request, options)
                .subscribe(reply -> {
    ...
    private void pageCreateHandler(RoutingContext context) {
        String pageNum = context.request().getParam("name");
        String location = "/wiki/" + pageNum;
    ...
    private void indexHandler(RoutingContext context) {
        ...
        vertx.eventBus()
                .rxSend(wikiDbQueue, new JsonObject(), options)
                .subscribe(reply -> {
                    JsonObject body = (JsonObject) reply.body();
                    context.put("title", "Wiki home");
                    context.put("pages", body.getJsonArray("pages").getList());
                    templateEngine
                            .rxRender(context.data(), "templates/index.ftl")
                            .subscribe(res -> {
    ...
    private void pageRenderingHandler(RoutingContext context) {
        ...
        vertx.eventBus()
                ...
                .subscribe(reply -> {
                    ...
                    templateEngine.rxRender(context.data(), "templates/page.ftl")
                            .subscribe(res -> {
                                context.response().putHeader("Content-Type", "text/html");
                                context.response().end(res);
                            }, context::fail);
